...
!
! Run with:  mpirun -np <P> ./psb_d_comm_test
!
program psb_d_comm_test
  use psb_base_mod
  use psb_util_mod
  ...
  if (my_rank == 0) then
    ...
    if (use_external_matrix) then
      ...
      write(psb_out_unit,'("  Grid      : ",i0," x ",i0," x ",i0)') idim,idim,idim
        ...
        write(psb_out_unit,'("  Usage     : ./psb_d_comm_test [--dim N] [--iters N] [--mode ...] ",&
