...
contains
  subroutine s_usmv_2_n_ap3_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    ...
    integer(psb_lpk_) :: IA(3)=(/1, 1, 2/)
    integer(psb_lpk_) :: JA(3)=(/1, 2, 2/)
    real*4 :: VA(3)=(/1, 1, 1/)
...
9999 continue
  ...
  subroutine s_usmv_2_t_ap3_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
    ...
    integer(psb_ipk_) :: m=2
    integer(psb_ipk_) :: k=2
    integer(psb_lpk_) :: IA(2)=(/1, 2/)
    integer(psb_lpk_) :: JA(2)=(/1, 1/)
    real*4 :: VA(2)=(/1, 1/)
    real*4 :: x(2)=(/1, 1/)! reference x 
...
9999 continue
  ...
  subroutine s_usmv_2_c_ap3_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_n_ap3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
    ...
    integer(psb_ipk_) :: m=2
    integer(psb_ipk_) :: k=2
    integer(psb_lpk_) :: IA(2)=(/1, 1/)
    integer(psb_lpk_) :: JA(2)=(/1, 2/)
    real*4 :: VA(2)=(/1, 2/)
    real*4 :: x(2)=(/1, 1/)! reference x 
...
9999 continue
  ...
  subroutine s_usmv_2_t_ap3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_c_ap3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_n_ap1_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
    ...
    integer(psb_ipk_) :: m=2
    integer(psb_ipk_) :: k=2
    integer(psb_lpk_) :: IA(1)=(/1/)
    integer(psb_lpk_) :: JA(1)=(/1/)
    real*4 :: VA(1)=(/1/)
    real*4 :: x(2)=(/1, 1/)! reference x 
...
9999 continue
  ...
  subroutine s_usmv_2_t_ap1_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_c_ap1_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
    ...
    integer(psb_ipk_) :: m=2
    integer(psb_ipk_) :: k=2
    integer(psb_lpk_) :: IA(4)=(/1, 1, 2, 2/)
    integer(psb_lpk_) :: JA(4)=(/1, 2, 1, 2/)
    real*4 :: VA(4)=(/1, 2, 5, 1/)
    real*4 :: x(2)=(/1, 1/)! reference x 
    real*4 :: cy(2)=(/9, 6/)! reference cy after 
    real*4 :: bcy(2)=(/3, 3/)! reference bcy before 
...
9999 continue
  ...
  subroutine s_usmv_2_n_ap1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_t_ap1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_c_ap1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_n_am1_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_t_am1_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_c_am1_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_n_am1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_t_am1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_c_am1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_n_am3_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_t_am3_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_c_am3_bp1_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_n_am3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_t_am3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_usmv_2_c_am3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_n_ap3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_t_ap3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_c_ap3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_n_ap1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_t_ap1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_c_ap1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_n_am1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_t_am1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_c_am1_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_n_am3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_t_am3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
...
9999 continue
  ...
  subroutine s_ussv_2_c_am3_bm0_ix1_iy1(res,afmt,ctxt)
    use psb_base_mod
    implicit none
    character(len=*) :: afmt
    type(psb_sspmat_type) :: a
