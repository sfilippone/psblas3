...
subroutine s_coo_cssm_impl(alpha,a,x,beta,y,info,trans) 
  ...
  use psb_error_mod
  use psb_string_mod
  use psb_s_base_mat_mod, psb_protect_name => s_coo_cssm_impl
  implicit none 
...
subroutine s_coo_cssv_impl(alpha,a,x,beta,y,info,trans) 
  ...
  use psb_error_mod
  use psb_string_mod
  use psb_s_base_mat_mod, psb_protect_name => s_coo_cssv_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(in) :: a
  real(psb_spk_), intent(in)          :: alpha, beta, x(:)
  real(psb_spk_), intent(inout)       :: y(:)
...
function s_coo_csnmi_impl(a) result(res)
  use psb_error_mod
  use psb_s_base_mat_mod, psb_protect_name => s_coo_csnmi_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(in) :: a
  real(psb_spk_)         :: res
...
subroutine s_coo_csgetptn_impl(imin,imax,a,nz,ia,ja,info,&
  ...
  use psb_const_mod
  use psb_error_mod
  use psb_s_base_mat_mod, psb_protect_name => s_coo_csgetptn_impl
  implicit none
  ...
  call coo_getptn(imin,imax,jmin_,jmax_,a,nz,ia,ja,nzin_,appens_,info,&
       & iren)
...
subroutine s_coo_csgetrow_impl(imin,imax,a,nz,ia,ja,val,info,&
  ...
  use psb_const_mod
  use psb_error_mod
  use psb_s_base_mat_mod, psb_protect_name => s_coo_csgetrow_impl
  implicit none
  ...
  call coo_getrow(imin,imax,jmin_,jmax_,a,nz,ia,ja,val,nzin_,appens_,info,&
       & iren)
...
subroutine s_coo_csput_impl(nz,ia,ja,val,a,imin,imax,jmin,jmax,info,gtl) 
  ...
  use psb_realloc_mod
  use psb_sort_mod
  use psb_s_base_mat_mod, psb_protect_name => s_coo_csput_impl
  implicit none 
...
subroutine s_cp_coo_to_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_cp_coo_to_coo_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(in) :: a
...
subroutine s_cp_coo_from_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_cp_coo_from_coo_impl
  implicit none 
...
subroutine s_cp_coo_to_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_cp_coo_to_fmt_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(in) :: a
...
subroutine s_cp_coo_from_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_cp_coo_from_fmt_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(inout) :: a
...
subroutine s_fix_coo_impl(a,info,idir) 
  ...
  use psb_s_base_mat_mod, psb_protect_name => s_fix_coo_impl
  implicit none 
  ...
  call s_fix_coo_inner(nza,dupl_,a%ia,a%ja,a%val,i,info,idir_)
...
subroutine s_fix_coo_inner(nzin,dupl,ia,ja,val,nzout,info,idir) 
  ...
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_fix_coo_inner
  use psb_string_mod
  use psb_ip_reord_mod
  implicit none 
...
subroutine s_mv_coo_to_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_mv_coo_to_coo_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(inout) :: a
  class(psb_s_coo_sparse_mat), intent(out) :: b
  integer, intent(out)            :: info
...
subroutine s_mv_coo_from_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_mv_coo_from_coo_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(inout) :: a
...
subroutine s_mv_coo_to_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_mv_coo_to_fmt_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(inout) :: a
  class(psb_s_base_sparse_mat), intent(out) :: b
  integer, intent(out)            :: info
...
subroutine s_mv_coo_from_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_s_base_mat_mod, psb_protect_name => s_mv_coo_from_fmt_impl
  implicit none 
  class(psb_s_coo_sparse_mat), intent(inout) :: a
