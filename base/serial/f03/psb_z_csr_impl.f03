...
subroutine z_csr_csmv_impl(alpha,a,x,beta,y,info,trans) 
  use psb_error_mod
  use psb_string_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_csmv_impl
  implicit none 
  ...
  call z_csr_csmv_inner(m,n,alpha,a%irp,a%ja,a%val,&
...
contains
  subroutine z_csr_csmv_inner(m,n,alpha,irp,ja,val,is_triangle,is_unit,&
       & x,beta,y,tra,ctra) 
  ...
  end subroutine z_csr_csmv_inner
...
subroutine z_csr_csmm_impl(alpha,a,x,beta,y,info,trans) 
  use psb_error_mod
  use psb_string_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_csmm_impl
  implicit none 
  class(psb_z_csr_sparse_mat), intent(in) :: a
  complex(psb_dpk_), intent(in)          :: alpha, beta, x(:,:)
  complex(psb_dpk_), intent(inout)       :: y(:,:)
  ...
  call  z_csr_csmm_inner(m,n,nc,alpha,a%irp,a%ja,a%val, &
...
contains
  subroutine z_csr_csmm_inner(m,n,nc,alpha,irp,ja,val,&
  ...
  end subroutine z_csr_csmm_inner
...
subroutine z_csr_cssv_impl(alpha,a,x,beta,y,info,trans) 
  use psb_error_mod
  use psb_string_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_cssv_impl
  implicit none 
  class(psb_z_csr_sparse_mat), intent(in) :: a
  complex(psb_dpk_), intent(in)          :: alpha, beta, x(:)
  complex(psb_dpk_), intent(inout)       :: y(:)
...
subroutine z_csr_cssm_impl(alpha,a,x,beta,y,info,trans) 
  use psb_error_mod
  use psb_string_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_cssm_impl
  implicit none 
  class(psb_z_csr_sparse_mat), intent(in) :: a
  complex(psb_dpk_), intent(in)          :: alpha, beta, x(:,:)
  complex(psb_dpk_), intent(inout)       :: y(:,:)
...
function z_csr_csnmi_impl(a) result(res)
  use psb_error_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_csnmi_impl
  implicit none 
  class(psb_z_csr_sparse_mat), intent(in) :: a
  real(psb_dpk_)         :: res
...
subroutine z_csr_csgetptn_impl(imin,imax,a,nz,ia,ja,info,&
  ...
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_csgetptn_impl
  implicit none
...
subroutine z_csr_csgetrow_impl(imin,imax,a,nz,ia,ja,val,info,&
  ...
  use psb_error_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_csgetrow_impl
  implicit none
...
subroutine z_csr_csput_impl(nz,ia,ja,val,a,imin,imax,jmin,jmax,info,gtl) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_csr_csput_impl
  implicit none 
  ...
  if (a%is_bld()) then 
    ...
    call  z_csr_srch_upd(nz,ia,ja,val,a,&
...
contains
  ...
  subroutine z_csr_srch_upd(nz,ia,ja,val,a,&
       & imin,imax,jmin,jmax,info,gtl)
...
subroutine z_cp_csr_from_coo_impl(a,b,info) 
  ...
  use psb_realloc_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_cp_csr_from_coo_impl
  implicit none 
...
subroutine z_cp_csr_to_coo_impl(a,b,info) 
  use psb_const_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_cp_csr_to_coo_impl
  implicit none 
...
subroutine z_mv_csr_to_coo_impl(a,b,info) 
  ...
  use psb_realloc_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_mv_csr_to_coo_impl
  implicit none 
...
subroutine z_mv_csr_from_coo_impl(a,b,info) 
  ...
  use psb_realloc_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_mv_csr_from_coo_impl
  implicit none 
...
subroutine z_mv_csr_to_fmt_impl(a,b,info) 
  ...
  use psb_realloc_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_mv_csr_to_fmt_impl
  implicit none 
...
subroutine z_cp_csr_to_fmt_impl(a,b,info) 
  ...
  use psb_realloc_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_cp_csr_to_fmt_impl
  implicit none 
...
subroutine z_mv_csr_from_fmt_impl(a,b,info) 
  ...
  use psb_realloc_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_mv_csr_from_fmt_impl
  implicit none 
...
subroutine z_cp_csr_from_fmt_impl(a,b,info) 
  ...
  use psb_realloc_mod
  use psb_z_base_mat_mod
  use psb_z_csr_mat_mod, psb_protect_name => z_cp_csr_from_fmt_impl
  implicit none 
