...
subroutine z_coo_cssm_impl(alpha,a,x,beta,y,info,trans) 
  ...
  use psb_error_mod
  use psb_string_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_cssm_impl
  implicit none 
...
subroutine z_coo_cssv_impl(alpha,a,x,beta,y,info,trans) 
  ...
  use psb_error_mod
  use psb_string_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_cssv_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(in) :: a
  complex(psb_dpk_), intent(in)          :: alpha, beta, x(:)
  complex(psb_dpk_), intent(inout)       :: y(:)
...
subroutine z_coo_csmv_impl(alpha,a,x,beta,y,info,trans) 
  ...
  use psb_error_mod
  use psb_string_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_csMv_impl
  implicit none 
...
subroutine z_coo_csmm_impl(alpha,a,x,beta,y,info,trans) 
  ...
  use psb_error_mod
  use psb_string_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_csmm_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(in) :: a
  complex(psb_dpk_), intent(in)          :: alpha, beta, x(:,:)
  complex(psb_dpk_), intent(inout)       :: y(:,:)
...
function z_coo_csnmi_impl(a) result(res)
  use psb_error_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_csnmi_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(in) :: a
  real(psb_dpk_)         :: res
...
subroutine z_coo_csgetptn_impl(imin,imax,a,nz,ia,ja,info,&
  ...
  use psb_const_mod
  use psb_error_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_csgetptn_impl
  implicit none
...
subroutine z_coo_csgetrow_impl(imin,imax,a,nz,ia,ja,val,info,&
  ...
  use psb_const_mod
  use psb_error_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_csgetrow_impl
  implicit none
...
subroutine z_coo_csput_impl(nz,ia,ja,val,a,imin,imax,jmin,jmax,info,gtl) 
  ...
  use psb_realloc_mod
  use psb_sort_mod
  use psb_z_base_mat_mod, psb_protect_name => z_coo_csput_impl
  implicit none 
...
subroutine z_cp_coo_to_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_cp_coo_to_coo_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(in) :: a
...
subroutine z_cp_coo_from_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_cp_coo_from_coo_impl
  implicit none 
...
subroutine z_cp_coo_to_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_cp_coo_to_fmt_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(in) :: a
...
subroutine z_cp_coo_from_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_cp_coo_from_fmt_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(inout) :: a
...
subroutine z_fix_coo_impl(a,info,idir) 
  ...
  use psb_z_base_mat_mod, psb_protect_name => z_fix_coo_impl
  implicit none 
  ...
  call z_fix_coo_inner(nza,dupl_,a%ia,a%ja,a%val,i,info,idir_)
...
subroutine z_fix_coo_inner(nzin,dupl,ia,ja,val,nzout,info,idir) 
  ...
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_fix_coo_inner
  use psb_string_mod
  use psb_ip_reord_mod
  implicit none 
...
subroutine z_mv_coo_to_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_mv_coo_to_coo_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(inout) :: a
  class(psb_z_coo_sparse_mat), intent(out) :: b
  integer, intent(out)            :: info
...
subroutine z_mv_coo_from_coo_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_mv_coo_from_coo_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(inout) :: a
...
subroutine z_mv_coo_to_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_mv_coo_to_fmt_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(inout) :: a
  class(psb_z_base_sparse_mat), intent(out) :: b
  integer, intent(out)            :: info
...
subroutine z_mv_coo_from_fmt_impl(a,b,info) 
  use psb_error_mod
  use psb_realloc_mod
  use psb_z_base_mat_mod, psb_protect_name => z_mv_coo_from_fmt_impl
  implicit none 
  class(psb_z_coo_sparse_mat), intent(inout) :: a
