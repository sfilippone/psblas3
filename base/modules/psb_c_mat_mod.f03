module psb_c_mat_mod
  ...
  contains
    ...
    procedure, pass(a) :: sizeof => c_sizeof
    ...
    procedure, pass(a) :: c_cscnv
    procedure, pass(a) :: c_cscnv_ip
    generic, public    :: cscnv => c_cscnv, c_cscnv_ip
    procedure, pass(a) :: reinit
    procedure, pass(a) :: print => sparse_print
    procedure, pass(a) :: c_mv_from
    generic, public    :: mv_from => c_mv_from
    procedure, pass(a) :: c_cp_from
    ...
    procedure, pass(a) :: c_csmv
    procedure, pass(a) :: c_csmm
  ...
  private :: get_nrows, get_ncols, get_nzeros, get_size, &
       ...
       & is_unit, get_neigh, csall, csput, c_csgetrow,&
       & c_csgetblk, csclip, c_cscnv, c_cscnv_ip, &
       ...
       & set_unit, get_diag, get_nz_row, c_csgetptn, &
       & c_mv_from, c_cp_from

  interface psb_sizeof
    module procedure c_sizeof
  end interface

  interface psb_move_alloc 
    module procedure c_sparse_mat_move
  end interface

  interface psb_clone
    module procedure c_sparse_mat_clone
  end interface

  interface psb_csmm
    module procedure c_csmm, c_csmv
  end interface

  interface psb_cssm
    module procedure c_cssm, c_cssv
  end interface
  ...
  interface psb_scal
    module procedure c_scals, c_scal
  end interface
...
contains 
  ...
  function c_sizeof(a) result(res)
    implicit none 
...
9999 continue
  ...
  subroutine c_csgetptn(imin,imax,a,nz,ia,ja,info,&
...
9999 continue
  ...
  subroutine c_cscnv(a,b,info,type,mold,upd,dupl)
    use psb_error_mod
    use psb_string_mod
    implicit none 
    class(psb_c_sparse_mat), intent(in)    :: a
...
9999 continue
  ...
  end subroutine c_cscnv


  subroutine c_cscnv_ip(a,info,type,mold,dupl)
    use psb_error_mod
    use psb_string_mod
    implicit none 
...
9999 continue
  ...
  end subroutine c_cscnv_ip

  subroutine c_mv_from(a,b)
    use psb_error_mod
    use psb_string_mod
    implicit none 
    class(psb_c_sparse_mat), intent(out) :: a
    ...
    return
  end subroutine c_mv_from

  subroutine c_cp_from(a,b)
    use psb_error_mod
    use psb_string_mod
    implicit none 
    class(psb_c_sparse_mat), intent(out) :: a
...
9999 continue
  ...
  end subroutine c_cp_from

  subroutine c_sparse_mat_move(a,b,info)
    use psb_error_mod
    use psb_string_mod
    implicit none 
    class(psb_c_sparse_mat), intent(inout) :: a
    ...
    return
  end subroutine c_sparse_mat_move

  subroutine c_sparse_mat_clone(a,b,info)
    use psb_error_mod
    use psb_string_mod
    implicit none 
    class(psb_c_sparse_mat), intent(in)  :: a
...
9999 continue
  ...
  end subroutine c_sparse_mat_clone
...
9999 continue
  ...
  subroutine c_csmm(alpha,a,x,beta,y,info,trans) 
    use psb_error_mod
    implicit none 
    class(psb_c_sparse_mat), intent(in) :: a
...
9999 continue
  ...
  end subroutine c_csmm

  subroutine c_csmv(alpha,a,x,beta,y,info,trans) 
    use psb_error_mod
    implicit none 
    class(psb_c_sparse_mat), intent(in) :: a
    complex(psb_spk_), intent(in)    :: alpha, beta, x(:)
