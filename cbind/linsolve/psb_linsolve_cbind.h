...
typedef struct psb_c_solveroptions {
  psb_c_i_t iter;       /* On exit how many iterations were performed */
  psb_c_i_t itmax;      /* On entry maximum number of iterations      */
  psb_c_i_t itrace;     /* On entry print an info message every itrace iterations */
  psb_c_i_t irst;       /* Restart depth for RGMRES or BiCGSTAB(L)    */
  psb_c_i_t istop;      /* Stopping criterion: 1:backward error 2: ||r||_2/||b||_2 */
...
psb_c_i_t psb_c_dkrylov(const char *method, psb_c_dspmat *ah, psb_c_dprec *ph, 
		  psb_c_dvector *bh, psb_c_dvector *xh,
		  psb_c_descriptor *cdh, psb_c_SolverOptions *opt);

psb_c_i_t psb_c_ckrylov(const char *method, psb_c_cspmat *ah, psb_c_cprec *ph, 
		  psb_c_cvector *bh, psb_c_cvector *xh,
		  psb_c_descriptor *cdh, psb_c_SolverOptions *opt);

psb_c_i_t psb_c_zkrylov(const char *method, psb_c_zspmat *ah, psb_c_zprec *ph, 
		  psb_c_zvector *bh, psb_c_zvector *xh,
		  psb_c_descriptor *cdh, psb_c_SolverOptions *opt);


  
psb_c_i_t psb_c_srichardson(psb_c_sspmat *ah, psb_c_sprec *ph, 
		  psb_c_svector *bh, psb_c_svector *xh,
		  psb_c_descriptor *cdh, psb_c_SolverOptions *opt);

psb_c_i_t psb_c_drichardson(psb_c_dspmat *ah, psb_c_dprec *ph, 
		  psb_c_dvector *bh, psb_c_dvector *xh,
		  psb_c_descriptor *cdh, psb_c_SolverOptions *opt);

psb_c_i_t psb_c_crichardson(psb_c_cspmat *ah, psb_c_cprec *ph, 
		  psb_c_cvector *bh, psb_c_cvector *xh,
		  psb_c_descriptor *cdh, psb_c_SolverOptions *opt);

psb_c_i_t psb_c_zrichardson(psb_c_zspmat *ah, psb_c_zprec *ph, 
		  psb_c_zvector *bh, psb_c_zvector *xh,
		  psb_c_descriptor *cdh, psb_c_SolverOptions *opt);
