submodule (psb_d_psblas_cbind_mod) psb_d_psblas_cbind_impl
  use iso_c_binding
  use psb_base_mod
...
contains
  ...
  module function psb_c_dspmm_opt(alpha,ah,xh,beta,yh,cdh,trans,doswap) bind(c) result(res)
    implicit none
    integer(psb_c_ipk_) :: res
...
end submodule psb_d_psblas_cbind_impl
