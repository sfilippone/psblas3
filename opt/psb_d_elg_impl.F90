...
subroutine psb_d_elg_csmv(alpha,a,x,beta,y,info,trans) 
  ...
  ! 
  if (info == 0) &
       & info = allocVecDevice(gpX,size(x),elldev_double)
  if (info == 0) &
       & info = writeVecDevice(gpX,x)
  if (info == 0) &
       & info = allocVecDevice(gpY,size(y),elldev_double)
  if (info == 0) &
       & info = writeVecDevice(gpY,y)
  
  if (info == 0)  &
       & info = spmvEllDevice(a%deviceMat,alpha,gpX,beta,gpY)
  call freeVecDevice(gpX)
  call freeVecDevice(gpY)

#else
  call a%psb_d_ell_sparse_mat%d_csmv(alpha,x,beta,y,info,trans) 
#endif
...
subroutine psb_d_elg_csmm(alpha,a,x,beta,y,info,trans) 
  ...
  call  psb_d_elg_csmm_inner(m,n,nxy,alpha,size(a%ja,2),&
...
contains
  subroutine psb_d_elg_csmm_inner(m,n,nxy,alpha,nc,ja,ldj,val,ldv,&
  ...
  end subroutine psb_d_elg_csmm_inner

end subroutine psb_d_elg_csmm


subroutine psb_d_elg_cssv(alpha,a,x,beta,y,info,trans) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_cssv
  implicit none 
  class(psb_d_elg_sparse_mat), intent(in) :: a
  real(psb_dpk_), intent(in)          :: alpha, beta, x(:)
  real(psb_dpk_), intent(inout)       :: y(:)
  ...
  logical   :: tra
  Integer :: err_act
  character(len=20)  :: name='d_elg_cssv'
  logical, parameter :: debug=.false.
  ...
  if (beta == dzero) then 
    ...
    call inner_elgsv(tra,a%is_lower(),a%is_unit(),a%get_nrows(),&
...
contains 
  ...
  subroutine inner_elgsv(tra,lower,unit,n,nc,irn,idiag,ja,ldj,val,ldv,x,y,info) 
    implicit none 
  ...
  end subroutine inner_elgsv

end subroutine psb_d_elg_cssv



subroutine psb_d_elg_cssm(alpha,a,x,beta,y,info,trans) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_cssm
  implicit none 
  class(psb_d_elg_sparse_mat), intent(in) :: a
  real(psb_dpk_), intent(in)          :: alpha, beta, x(:,:)
  real(psb_dpk_), intent(inout)       :: y(:,:)
  ...
  logical   :: tra
  Integer :: err_act
  character(len=20)  :: name='d_elg_cssm'
  logical, parameter :: debug=.false.
  ...
  if (beta == dzero) then 
    ...
    call inner_elgsm(tra,a%is_lower(),a%is_unit(),a%get_nrows(),nxy,&
         & size(a%ja,2),a%irn,a%idiag,a%ja,size(a%ja,1),a%val,size(a%val,1),&
...
contains 
  ...
  subroutine inner_elgsm(tra,lower,unit,n,nc,nxy,irn,idiag,ja,ldj,val,ldv,&
  ...
  end subroutine inner_elgsm

end subroutine psb_d_elg_cssm


function psb_d_elg_csnmi(a) result(res)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_csnmi
  implicit none 
  class(psb_d_elg_sparse_mat), intent(in) :: a
  real(psb_dpk_)         :: res
...
end function psb_d_elg_csnmi


function psb_d_elg_csnm1(a) result(res)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_csnm1
  ...
  logical   :: tra
  Integer :: err_act
  character(len=20)  :: name='d_elg_csnm1'
  logical, parameter :: debug=.false.
...
end function psb_d_elg_csnm1


subroutine psb_d_elg_rowsum(d,a) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_rowsum
  class(psb_d_elg_sparse_mat), intent(in) :: a
...
end subroutine psb_d_elg_rowsum

subroutine psb_d_elg_arwsum(d,a) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_arwsum
  class(psb_d_elg_sparse_mat), intent(in) :: a
  real(psb_dpk_), intent(out)              :: d(:)
...
end subroutine psb_d_elg_arwsum

subroutine psb_d_elg_colsum(d,a) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_colsum
  class(psb_d_elg_sparse_mat), intent(in) :: a
  real(psb_dpk_), intent(out)              :: d(:)
...
end subroutine psb_d_elg_colsum

subroutine psb_d_elg_aclsum(d,a) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_aclsum
  class(psb_d_elg_sparse_mat), intent(in) :: a
  real(psb_dpk_), intent(out)              :: d(:)
...
end subroutine psb_d_elg_aclsum


subroutine psb_d_elg_get_diag(a,d,info) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_get_diag
  implicit none 
  class(psb_d_elg_sparse_mat), intent(in) :: a
  real(psb_dpk_), intent(out)     :: d(:)
  integer, intent(out)            :: info
...
end subroutine psb_d_elg_get_diag
...
subroutine psb_d_elg_mold(a,b,info) 
  ...
  allocate(psb_d_elg_sparse_mat :: b, stat=info)
...
subroutine psb_d_elg_csgetptn(imin,imax,a,nz,ia,ja,info,&
     & jmin,jmax,iren,append,nzin,rscale,cscale)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_csgetptn
  implicit none
  ...
  call elg_getptn(imin,imax,jmin_,jmax_,a,nz,ia,ja,nzin_,append_,info,iren)
...
contains
  ...
  subroutine elg_getptn(imin,imax,jmin,jmax,a,nz,ia,ja,nzin,append,info,&
       & iren)
    ...
    character(len=20) :: name='elg_getptn'
  ...
  end subroutine elg_getptn
  
end subroutine psb_d_elg_csgetptn


subroutine psb_d_elg_csgetrow(imin,imax,a,nz,ia,ja,val,info,&
     & jmin,jmax,iren,append,nzin,rscale,cscale)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_csgetrow
  implicit none
  ...
  call elg_getrow(imin,imax,jmin_,jmax_,a,nz,ia,ja,val,nzin_,append_,info,&
       & iren)
...
contains
  ...
  subroutine elg_getrow(imin,imax,jmin,jmax,a,nz,ia,ja,val,nzin,append,info,&
       & iren)
  ...
  end subroutine elg_getrow

end subroutine psb_d_elg_csgetrow

subroutine psb_d_elg_csgetblk(imin,imax,a,b,info,&
     & jmin,jmax,iren,append,rscale,cscale)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_csgetblk
  implicit none
...
end subroutine psb_d_elg_csgetblk



subroutine psb_d_elg_csput(nz,ia,ja,val,a,imin,imax,jmin,jmax,info,gtl) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_csput
  implicit none 
  ...
  Integer            :: err_act
  character(len=20)  :: name='d_elg_csput'
  logical, parameter :: debug=.false.
  ...
  if (a%is_bld()) then 
    ...
    call  psb_d_elg_srch_upd(nz,ia,ja,val,a,&
...
contains
  ...
  subroutine psb_d_elg_srch_upd(nz,ia,ja,val,a,&
       & imin,imax,jmin,jmax,info,gtl)
    ...
    integer              :: debug_level, debug_unit
    character(len=20)    :: name='d_elg_srch_upd'
  ...
  end subroutine psb_d_elg_srch_upd

end subroutine psb_d_elg_csput



subroutine psb_d_elg_reinit(a,clear)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_reinit
  implicit none 
...
end subroutine psb_d_elg_reinit
...
subroutine psb_d_elg_print(iout,a,iv,eirs,eics,head,ivr,ivc)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_print
  implicit none 
  ...
  Integer :: err_act
  character(len=20)  :: name='d_elg_print'
  logical, parameter :: debug=.false.
...
end subroutine psb_d_elg_print
...
subroutine psb_d_cp_elg_to_coo(a,b,info) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_cp_elg_to_coo
  implicit none 
...
end subroutine psb_d_cp_elg_to_coo

subroutine psb_d_mv_elg_to_coo(a,b,info) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_mv_elg_to_coo
  implicit none 
...
9999 continue
  info = psb_err_alloc_dealloc_
  return
end subroutine psb_d_mv_elg_to_coo
...
subroutine psb_d_mv_elg_to_fmt(a,b,info) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_mv_elg_to_fmt
  implicit none 
...
end subroutine psb_d_mv_elg_to_fmt


subroutine psb_d_cp_elg_to_fmt(a,b,info) 
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_cp_elg_to_fmt
  implicit none 
...
end subroutine psb_d_cp_elg_to_fmt
...
subroutine psb_d_elg_cp_from(a,b)
  use psb_sparse_mod
  use psb_d_elg_mat_mod, psb_protect_name => psb_d_elg_cp_from
  implicit none 
