...
\item[psb\_dpk\_] Kind parameter for long precision real and complex
  ...
  normally 8 bytes. 
\item[psb\_long\_int\_k\_] Kind parameter for long integers, used by
  the \verb|psb_sizeof| utility.
\end{description}
...
\label{sec:spmat}
The \hypertarget{spdata}{{\tt psb\_spmat\_type}} class
...
\end{description}
The actual data is contained in the polymorphic component \verb|a%a|; its
